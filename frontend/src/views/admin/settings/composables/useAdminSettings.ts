...
export function useAdminSettings() {
  ...
  const smsAccessKeyPlaceholder = computed(() => {
    if (state.smsForm.sms_provider === 'tencent')
      return t('adminSettings.smsTencentSecretId')
    if (state.smsForm.sms_provider === 'custom')
      return t('adminSettings.smsCustomApiKeyOptional')
    return t('adminSettings.smsProviderAccessKey')
  })
  const smsSecretKeyPlaceholder = computed(() => {
    if (state.smsForm.sms_provider === 'tencent')
      return t('adminSettings.smsTencentSecretKey')
    if (state.smsForm.sms_provider === 'custom')
      return t('adminSettings.smsCustomApiSecretOptional')
  ...
  return {
    ...
    testSmsPhone: state.testSmsPhone,
