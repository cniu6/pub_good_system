...
type EmailTemplate struct {
    ...
    Name        string    `db:"name" json:"name"`           // 模板标识名
    Lang        string    `db:"lang" json:"lang"`           // 语言代码 (zh-CN/en-US)
    Title       string    `db:"title" json:"title"`         // 模板标题
    Subject     string    `db:"subject" json:"subject"`     // 邮件主题
    Content     string    `db:"content" json:"content"`     // 邮件内容
    Description string    `db:"description" json:"description"` // 描述
    Variables   string    `db:"variables" json:"variables"` // 可用变量说明
    Status      int       `db:"status" json:"status"`       // 状态 (0禁用/1启用)
...
type EmailLog struct {
    ID           uint64    `db:"id" json:"id"`
    ToEmail      string    `db:"to_email" json:"to_email"`           // 收件人
    Subject      string    `db:"subject" json:"subject"`             // 主题
    Content      string    `db:"content" json:"content"`             // 内容
    TemplateName string    `db:"template_name" json:"template_name"` // 使用的模板
    Status       int       `db:"status" json:"status"`               // 状态 (0失败/1成功)
...
| InitEmailTemplates | `func InitEmailTemplates()` | 初始化默认模板 |
