...
// @Router /v1/user/email/send-code [post]
...
// @Success 200 {object} utils.Response
// @Router /v1/user/email/verify [post]
...
// @Success 200 {object} utils.Response
// @Router /v1/user/phone/send-code [post]
...
// @Success 200 {object} utils.Response
// @Router /v1/user/phone/verify [post]
...
// @Success 200 {object} utils.Response
// @Router /v1/user/deactivate [post]
