...
// @Router /v1/admin/online/stats [get]
...
// @Security BearerAuth
// @Success 200 {object} utils.Response
// @Router /v1/admin/online/sessions [get]
...
// UserSessions 返回指定用户的有效会话
// @Summary 指定用户的会话列表
// @Tags Admin-在线用户
// @Security BearerAuth
// @Success 200 {object} utils.Response
// @Router /v1/admin/users/{id}/sessions [get]
...
// @Security BearerAuth
// @Success 200 {object} utils.Response
// @Router /v1/admin/online/sessions/{id} [delete]
...
// RevokeAllUserSessions 强制下线用户全部会话
// @Summary 强制下线用户全部会话
// @Tags Admin-在线用户
// @Security BearerAuth
// @Success 200 {object} utils.Response
