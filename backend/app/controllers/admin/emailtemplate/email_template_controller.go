...
// @Success 200 {object} utils.Response
// @Router /v1/admin/email-templates/{id} [get]
...
// @Success 200 {object} utils.Response
// @Router /v1/admin/email-templates/{id} [put]
...
// @Success 200 {object} utils.Response
// @Router /v1/admin/email-templates/{id}/preview [post]
...
// @Param id path int true "模板ID"
// @Success 200 {object} utils.Response
// @Router /v1/admin/email-templates/{id}/reset [post]
...
// @Success 200 {object} utils.Response
// @Router /v1/admin/email-send-test [post]
