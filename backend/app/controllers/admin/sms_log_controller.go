...
// @Router /api/v1/admin/sms-logs [get]
...
// @Success 200 {object} utils.Response
// @Router /api/v1/admin/sms-logs/{id} [get]
...
// @Success 200 {object} utils.Response
// @Router /api/v1/admin/sms-logs/clean [post]
...
// @Security BearerAuth
// @Success 200 {object} utils.Response
// @Router /api/v1/admin/sms-logs/template-names [get]
