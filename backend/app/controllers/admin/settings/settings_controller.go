...
// @Router /v1/admin/settings/category/{category} [get]
...
// @Success 200 {object} utils.Response
// @Router /v1/admin/settings/{key} [get]
...
// @Success 200 {object} utils.Response
// @Router /v1/admin/settings/{key}/meta [put]
...
// @Success 200 {object} utils.Response
// @Router /v1/admin/settings/batch [put]
...
// @Param key path string true "配置键名"
// @Success 200 {object} utils.Response
// @Router /v1/admin/settings/{key} [delete]
