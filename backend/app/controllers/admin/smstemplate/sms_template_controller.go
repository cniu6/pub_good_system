...
// @Router /v1/admin/sms-templates [get]
...
// @Success 200 {object} utils.Response
// @Router /v1/admin/sms-templates/{id} [get]
...
// @Success 200 {object} utils.Response
// @Router /v1/admin/sms-templates/{id} [put]
...
// @Success 200 {object} utils.Response
// @Router /v1/admin/sms-templates/{id}/preview [post]
...
// @Param id path int true "模板ID"
// @Success 200 {object} utils.Response
// @Router /v1/admin/sms-templates/{id}/reset [post]
...
// @Success 200 {object} utils.Response
// @Router /v1/admin/sms-send-test [post]
