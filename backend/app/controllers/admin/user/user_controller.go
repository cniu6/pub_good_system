...
// @Success 200 {object} utils.Response
// @Router /v1/admin/users/batch-simple [post]
...
// @Param id path int true "用户ID"
// @Success 200 {object} utils.Response
// @Router /v1/admin/users/{id}/login-as [post]
...
// @Param id path int true "用户ID"
// @Success 200 {object} utils.Response
// @Router /v1/admin/users/{id}/reset-apikey [post]
...
// @Success 200 {object} utils.Response
// @Router /v1/admin/users/lookup [get]
