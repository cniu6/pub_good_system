...
var defaultSettings = []SystemSetting{
	...
	{Key: "allow_register", Value: "false", Type: "boolean", Category: "basic", Label: "允许注册", Description: "是否允许新用户注册（默认关闭；管理员登录不受影响）", IsPublic: true, IsEditable: true, SortOrder: 6},
	...
	{Key: "allow_user_login", Value: "false", Type: "boolean", Category: "basic", Label: "允许用户登录", Description: "关闭后普通用户无法密码登录获取 JWT（管理员登录与 API Key 不受影响）", IsPublic: true, IsEditable: true, SortOrder: 6},
