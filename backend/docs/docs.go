...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/admin/payment/channels/metas": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/v1/admin/payment/currency/base": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/v1/admin/payment/currency/config": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/app_controllers_admin_payment.CurrencyConfigRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/admin/payment/currency/rates": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/app_controllers_admin_payment.ExchangeRateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/admin/payment/currency/rates/batch-refresh": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/app_controllers_admin_payment.BatchRefreshRatesRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/admin/payment/currency/rates/batch-refresh/preview": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/v1/admin/payment/currency/rates/refresh": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/v1/admin/payment/currency/rates/{id}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/app_controllers_admin_payment.UpdateExchangeRateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/admin/payment/currency/rates/{id}/refresh": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/v1/admin/payment/gateways/{id}/test-connection": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/v1/public/payment/notify/:channel_type": {
            "post": {
                "tags": [
                    "Public-回调"
                ],
    ...
    "definitions": {
        ...
        "app_controllers_admin_payment.BatchRefreshRatesRequest": {
            "type": "object",
            "required": [
                "ids"
            ],
        ...
        "app_controllers_admin_payment.CurrencyConfigRequest": {
            "type": "object",
            "properties": {
                "base_currency": {
                    "type": "string",
        ...
        "app_controllers_admin_payment.ExchangeRateRequest": {
            "type": "object",
            "required": [
                "from_currency",
                "rate",
        ...
        "app_controllers_admin_payment.UpdateExchangeRateRequest": {
            "type": "object",
            "required": [
                "from_currency",
                "rate",
